...
// UART Åë½Å¿ë-----------------------------------------------------------------
char	gTx0Buf[TX0_BUF_SIZE];		// UART0 ¼Û½Å ¹öÆÛ
BYTE	gTx0Cnt;					// UART0 ¼Û½Å ´ë±â ¹ÙÀÌÆ® ¼ö
BYTE	gRx0Cnt;					// UART0 ¼ö½Å ¹ÙÀÌÆ® ¼ö
BYTE	gTx0BufIdx;					// UART0 ¼Û½Å ¹öÆÛ ÀÎµ¦½º
char	gRx0Buf[RX0_BUF_SIZE];		// UART0 ¼ö½Å ¹öÆÛ
