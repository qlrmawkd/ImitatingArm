...
unsigned int    gBtnCnt;			// Button press process counterÍ
...
char	gTx0Buf[186     ];		// UART0 transmission buffer 
unsigned char	gTx0Cnt;			// UART0 transmission idle byte number
unsigned char	gRx0Cnt;			// UART0 receiving byte number
unsigned char	gTx0BufIdx;			// UART0 transmission buffer indexº
char	gRx0Buf[8		];		// UART0 transmission buffer 
...
void main(void) {
    ...
        SendSetCmd(1, 12, 10, 10);  // ID 1¹ø wCkÀÇ ID¸¦ 10À¸·Î º¯°æ
